...
namespace FluentFTP {
	...
	public interface IFtpClient : IDisposable {
		...
		int DownloadFiles(string localDir, IEnumerable<string> remotePaths, LocalFileExists existsMode = LocalFileExists.Append, FtpVerify verifyOptions = FtpVerify.None, FtpError errorHandling = FtpError.None);
		...
		bool DownloadFile(string localPath, string remotePath, LocalFileExists existsMode = LocalFileExists.Append, FtpVerify verifyOptions = FtpVerify.None, IProgress<double> progress = null);
		...
		Task<int> DownloadFilesAsync(string localDir, IEnumerable<string> remotePaths, LocalFileExists existsMode, FtpVerify verifyOptions, FtpError errorHandling, CancellationToken token);
		Task<int> DownloadFilesAsync(string localDir, IEnumerable<string> remotePaths, LocalFileExists existsMode = LocalFileExists.Append, FtpVerify verifyOptions = FtpVerify.None, FtpError errorHandling = FtpError.None);
		...
		Task<bool> DownloadFileAsync(string localPath, string remotePath, LocalFileExists existsMode, FtpVerify verifyOptions, CancellationToken token, IProgress<double> progress);
		Task<bool> DownloadFileAsync(string localPath, string remotePath, LocalFileExists existsMode = LocalFileExists.Append, FtpVerify verifyOptions = FtpVerify.None, IProgress<double> progress = null);
