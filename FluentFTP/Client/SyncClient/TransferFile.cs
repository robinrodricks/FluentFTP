...
namespace FluentFTP {
	public partial class FtpClient {
		...
		/// </summary>
		protected async Task<bool> TransferFileFXPInternalAsync(string sourcePath, FtpClient remoteClient, string remotePath, bool createRemoteDir, FtpRemoteExists existsMode,
