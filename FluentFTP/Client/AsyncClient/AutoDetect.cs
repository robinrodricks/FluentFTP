...
namespace FluentFTP {
	public partial class AsyncFtpClient {
		...
		/// <returns></returns>
		public Task<List<FtpProfile>> AutoDetect(FtpAutoDetectConfig config = null, CancellationToken token = default(CancellationToken)) {
			...
			return ConnectModule.AutoDetectAsync(this, config, token);
		}
