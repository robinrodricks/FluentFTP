...
namespace System.Net.FtpClient {
    ...
    public enum FtpEncryptionMode {
        ...
        None,
        /// <summary>
        /// Encryption is use from the start of the connection (SSL), port 990
        /// </summary>
        Implicit,
        /// <summary>
        /// Connection starts in plain text and encryption is enabled (TLS)
    ...
    public enum FtpDataConnectionType {
        ...
        /// servers may not implement the EPSV command.
        /// </summary>
        PASVEX,
        /// <summary>
        /// Extended passive data connection, recommended. Works
        /// the same as a passive connection except the server
