...
namespace FluentFTP.Tests.Unit {
	...
	public class PathSanitizerTests {
		...
		public void Pipe_Removed() {
			Assert.Equal("/file.txt", "/file.txt|whoami".SanitizeFtpPath());
		}
		...
		public void Whitespace_Trimmed1() {
			Assert.Equal("/file.txt", "   /file.txt   ".SanitizeFtpPath());
		}
		...
		public void Whitespace_Preserved1() {
			Assert.Equal("/file name.txt", "/file name.txt".SanitizeFtpPath());
		}
		...
		public void UnicodeControl_Removed() {
			Assert.Equal("/safe/txt.exe", "/safe/\u202Etxt.exe".SanitizeFtpPath());
		}
