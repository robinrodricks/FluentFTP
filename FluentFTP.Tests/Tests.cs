	...
	public class Tests
	{
		...
		public void TestUploadDownloadManyFiles2()
		{
			using (FtpClient cl = NewFtpClient())
			{
				...
				// download many
				cl.DownloadFiles(@"D:\Drivers\test\", new string[] { @"/public_html/temp/file0.exe", @"/public_html/temp/file1.exe", @"/public_html/temp/file2.exe", @"/public_html/temp/file3.exe", @"/public_html/temp/file4.exe" }, LocalFileExists.Append);
        ...
        public async Task TestUploadDownloadManyFiles2Async()
        {
            using (FtpClient cl = NewFtpClient())
            {
                ...
                // download many
                await cl.DownloadFilesAsync(@"D:\Drivers\test\", new string[] { @"/public_html/temp/file0.exe", @"/public_html/temp/file1.exe", @"/public_html/temp/file2.exe", @"/public_html/temp/file3.exe", @"/public_html/temp/file4.exe" }, LocalFileExists.Append);
