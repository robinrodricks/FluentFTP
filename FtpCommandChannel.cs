...
namespace System.Net.FtpClient {
    ...
    public class FtpCommandChannel : FtpChannel {
        ...
        protected FtpDataChannel OpenDataChannel() {
            return this.OpenDataChannel(this.DataChannelType, FtpDataType.Binary);
        }
        ...
        protected FtpDataChannel OpenDataChannel(FtpDataType datatype) {
            return this.OpenDataChannel(this.DataChannelType, datatype);
        }
        ...
        /// <returns></returns>
        protected FtpDataChannel OpenDataChannel(FtpDataChannelType chantype, FtpDataType datatype) {
