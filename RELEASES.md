...
#### 35.0.0
 ...
 - **File hashing**
   ...
   - Fix: `GetChecksum` validates if the required algorithm is unsupported and throws `FtpHashAlgorithmUnsupportedException`
   - Fix: `GetChecksum` validates if hashing is unsupported by the server and throws `FtpHashAlgorithmUnsupportedException`
