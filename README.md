...
It is written entirely in C#, with no external dependencies. It has an extensive automated test suite which test all FTP functionality against local FTP server docker containers.
